...
2. **Managed-node acceptance**
   ...
   jobs `#99208960112` and `#99208960115` remained `in_progress`
   after runner finalization stalled; normal cancellation was at `05:15 UTC`,
   force-cancel returned HTTP 202 at `05:17:32 UTC`, and the last snapshot still
   showed `in_progress`. No `v0.9.8` GitHub Release exists; do not delete or
