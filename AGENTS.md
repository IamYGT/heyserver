# HServer product contract

These rules apply to the entire repository in addition to the operator contract.

## Product direction

HServer is a provider-neutral, self-hosted server-management product. It must be
...
- Full local management runs natively because it needs controlled access to
  ...
  are managed through the least-privileged HServer agent contract.
